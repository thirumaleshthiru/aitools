...
<body>
    ...
    <main>
        <div class="tool-container">
            ...
            <h1><?php echo htmlspecialchars($tool['tool_name']); ?> <a href=<?php echo $tool['link']; ?>>Go</a></h1>
            <div><?php echo $tool['tool_description']; ?></div>
            </div>
            <div class="tool-details">
                <?php if ($tool['cover_image']): ?>
                    <img src="data:image/jpeg;base64,<?php echo base64_encode($tool['cover_image']); ?>" alt="<?php echo htmlspecialchars($tool['tool_name']); ?>">
            <?php endif; ?>
            </div>
